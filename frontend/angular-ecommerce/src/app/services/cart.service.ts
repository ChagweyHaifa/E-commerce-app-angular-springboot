...
export class CartService {
  ...
  computeCartTotals() {
    // Each time we call addToCart function, we calculate the total price starting from the first product 
    ...
    this.totalQuantityTest = totalQuantityValue;
